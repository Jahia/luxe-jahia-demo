...
/**
 * Regression coverage for the responsive images: hero images are prioritized
 * (LCP), lazy images reserve their dimensions (CLS), and JCR raster images
 * expose width-based srcset candidates. Every JCR image is rendered by the
 * platform image API (`<JImage>` / `getImageProps`).
 *
