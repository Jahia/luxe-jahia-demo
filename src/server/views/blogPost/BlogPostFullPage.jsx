...
import {
    useServerContext,
    getNodeProps,
    defineJahiaComponent, Render, server, useUrlBuilder
...
export const ArticleFullPage = () => {
    ...
    const {title, subtitle, image: imageNode, body, date, 'j:defaultCategory': categories, relatedBlogPosts} = getNodeProps(currentNode, [
        'title',
        'subtitle',
        'image',
        'body',
