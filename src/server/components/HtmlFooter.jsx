            ...
            <Row>
                <Col className="col-4">
                    ...
                    <ul className="list-unstyled">
                        <li>
                            <a className="text-capitalize" href="https://academy.jahia.com/home" target="_blank" rel="noreferrer">{t('footer.academy')}</a>
                        </li>
                        <li>
                            <a href="https://academy.jahia.com/get-started" target="_blank" rel="noreferrer">{t('footer.tutorial')}</a>
                        </li>
                        <li>
                            <a href="https://github.com/Jahia/luxe-jahia-demo/" target="_blank" rel="noreferrer">{t('footer.sourceCode')}</a>
                        </li>
                    </ul>
                </Col>
                <Col className="col-5">
